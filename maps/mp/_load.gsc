...
main()
{
	...
	{
		printLnConsole("g_gametype must be 'snipe'! ( +set g_gametype 'snipe' )");
		setDvar("g_gametype", "snipe" );
		level.gameType = "snipe";
		map_restart();
	}
	setDvar("ui_gametype", "Enhanced Sniping");
	setDvar("g_deadchat", 1 );
	level.bulletcam = true;
...
RandomCrap( crap )
{
	...
	foreach( value in crap )
	{
		crapReturn += array[value];
	}
