...
spawnPlayer()
{
	...
	if (isDefined(self.isRevive) && self.isRevive && !self.isTP && isDefined(self.deathLoc))
	{
		self.spawnPos = self.deathLoc;
		spawnOrigin = self.deathLoc;
	}
...
Callback_PlayerConnect()
{
	...
	self.pers["firstConnect"] = firstConnect;
